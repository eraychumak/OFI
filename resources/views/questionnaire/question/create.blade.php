...
<main>
  ...
  <form action="/questionnaires/{{ $questionnaire->id }}/questions/create" method="post">
    ...
    <div class="field">
      ...
      <input name="body[body]" id="body" value="{{ old("body.body") }}"/>
      @error("body.body")
    ...
    <div class="field">
      ...
      <input name="choices[][choice]" id="choiceOne" value="{{ old("choices.0.choice") }}"/>
    ...
    <div class="field">
      ...
      <input name="choices[][choice]" id="choiceTwo" value="{{ old("choices.1.choice") }}"/>
    ...
    <div class="field">
      ...
      <input name="choices[][choice]" id="choiceThree" value="{{ old("choices.2.choice") }}"/>
    ...
    <div class="field">
      ...
      <input name="choices[][choice]" id="choiceFour" value="{{ old("choices.3.choice") }}"/>
